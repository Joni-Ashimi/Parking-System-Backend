...
export class AuthService {
  ...
  async register(createUser: CreateUserDto) {
    ...
    const existingPhone = await this.usersService
      .findByPhone(createUser.phoneNumber)
      .catch(() => null);
    if (existingPhone) {
  ...
  async requestPasswordChange(userId: string, dto: RequestPasswordDto) {
    ...
    await this.emailService.sendPasswordRequestCode(user?.email, {
      email: user.email,
      code,
    });
  ...
  async confirmPasswordChange(userId: string, dto: ConfirmPasswordDto) {
    ...
    await this.usersService.partialUpdate(userId, {
